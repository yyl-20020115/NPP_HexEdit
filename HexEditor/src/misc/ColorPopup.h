...
{
public :
    ColorPopup() : Window(), isColorChooserLaunched(false),_color(),_hNpp(),_rc() {};
	ColorPopup(COLORREF defaultColor) : Window(), isColorChooserLaunched(false), _color(defaultColor), _hNpp(), _rc() {};
	~ColorPopup(){};
